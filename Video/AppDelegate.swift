    ...
    //        self.window?.addSubview(imageview!)
        ...
        func applicationDidEnterBackground(_ application: UIApplication) {
            ...
            // If your application supports background execution, this method is called instead of applicationWillTerminate: when the user quits.
             ...
             print("Image appear")
           // let sourceImg = screenShot()
            
           //let overlayView = [[UIImageView alloc]initWithFrame:[self.window frame]]
          //  let overlayView =  UIImageView.init(frame:(self.window?.frame)!)
          // overlayView.backgroundColor = UIColor.white
           // [self.overlayView setImage:snapShotOfSplash];
    //overlayView.image(setIm)
